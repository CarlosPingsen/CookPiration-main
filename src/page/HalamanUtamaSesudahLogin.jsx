        ...
        <Row className="mb-4">
          ...
          <Col md={6}>
            <h1 style={{marginTop : '30%'}} >Ciptakan kenangan indah dengan setiap <div className="text-oranye">
              hidangan</div> yang Anda buat. <br /> <br />  <a className="btn w-50 bg-oranye text-light m-auto"><Link to="../HalamanPencarian" state={{ userObject }} className="nav-link fw-bold me-4">
              Lihat Semua Resep
      </Link> <FontAwesomeIcon icon={faArrowRight} /></a>
            </h1>
          </Col>
        </Row>
        <Row>
            ...
            {reseps.map((resep)=>
              <CardResep key={resep.id}>
                ...
                {/* <Col>
                    ...
                    <Button variant="outline-warning" size="sm" onClick={() => simpanResepKeState(resep.id)}><FontAwesomeIcon icon={faBookmark} /></Button>{' '}
                    </Col>
                    </Col> */}
              </CardResep>
            )}
